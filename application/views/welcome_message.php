...
<head>
  <title>About</title>
<meta charset="utf-8">
<link rel="stylesheet" href="assets/template/css/reset.css" type="text/css" media="all">
<link rel="stylesheet" href="assets/template/css/layout.css" type="text/css" media="all">
<link rel="stylesheet" href="assets/template/css/style.css" type="text/css" media="all">
<script type="text/javascript" src="assets/template/js/jquery-1.5.2.js" ></script>
<script type="text/javascript" src="assets/template/js/cufon-yui.js"></script>
<script type="text/javascript" src="assets/template/js/cufon-replace.js"></script>  
<script type="text/javascript" src="assets/template/js/Cabin_400.font.js"></script>
...
<script type="text/javascript" src="assets/template/js/jquery.nivo.slider.pack.js"></script>
<script type="text/javascript" src="assets/template/js/atooltip.jquery.js"></script>
...
<!--header -->
	<header>
		<div class="wrapper">
			<h1><a href="assets/template/index.html" id="logo">Air lines</a></h1>
			<span id="slogan">Fast, Frequent &amp; Safe Flights</span>
			<nav id="top_nav">
				<ul>
					<li><a href="assets/template/index.html" class="nav1">Home</a></li>
					<li><a href="signup.php" class="nav2">Signup</a></li>
		...
		<nav>
			<ul id="menu">
				<li id="menu_active"><a href="assets/template/index.html"><span><span>About</span></span></a></li>
				<li><a href="assets/template/Offers.html"><span><span>Offers</span></span></a></li>
				<li><a href="assets/template/Book.html"><span><span>Book</span></span></a></li>
				<li><a href="assets/template/Services.html"><span><span>Services</span></span></a></li>
				<li><a href="assets/template/Safety.html"><span><span>Safety</span></span></a></li>
				<li class="end"><a href="assets/template/Contacts.html"><span><span>Contacts</span></span></a></li>
			</ul>
		</nav>
	...
	<section id="content">
		<div class="for_banners">
			<article class="col1">
					...
					<div id="slider">
						<img src="assets/template/images/banner1.jpg" alt="">
						<img src="assets/template/images/banner2.jpg" alt="">
						<img src="assets/template/images/banner3.jpg" alt="">
					</div>
				</div>
		<div class="wrapper pad1">
			<article class="col1">
				<div class="box1">
							...
							<div class="pad">
								...
								<ul class="pad_bot1 list1">
									<li>
										...
										<a href="assets/template/Book2.html">Zurich</a>
									</li>
								</ul>
								...
								<ul class="pad_bot1 list1">
									<li>
										...
										<a href="assets/template/Book2.html">Basel</a>
									</li>
									<li>
										<span class="right color1">from GBP 109.-</span>
										<a href="assets/template/Book2.html">Geneva</a>
									</li>
								</ul>
					...
					<article class="col2">
						...
						<div class="wrapper">
							<article class="cols">
								<figure><img src="assets/template/images/page1_img1.jpg" alt="" class="pad_bot2"></figure>
								<p class="pad_bot1"><strong>Airlines is one of <a href="assets/template/http://blog.templatemonster.com/free-website-templates/" target="_blank">free website templates</a> created by TemplateMonster.com team.</strong></p>
								<p>This website template is optimized for 1024X768 screen resolution. It is also XHTML &amp; CSS valid. This website template has several pages: <a href="assets/template/index.html">About</a>, <a href="assets/template/Offers.html">Offers</a>, <a href="assets/template/Book.html">Book</a>, <a href="assets/template/Services.html">Services</a>, <a href=assets/template/"Safety.html">Safety</a>, <a href="assets/templateContacts.html">Contacts</a>.</p>
							</article>
							<article class="cols pad_left1">
								<figure><img src="assets/template/images/page1_img2.jpg" alt="" class="pad_bot2"></figure>
								<p class="pad_bot1"><strong>This <a href="assets/template/http://blog.templatemonster.com/2011/05/09/free-website-template-airlines/" target="_blank">Airlines Template</a> goes with two packages.</strong></p>
			...
			<footer>
				<div class="wrapper">
					<ul id="icons">
						<li><a href="#" class="normaltip" title="Facebook"><img src="assets/template/images/icon1.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Delicious"><img src="assets/template/images/icon2.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Stumble Upon"><img src="assets/template/images/icon3.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Twitter"><img src="assets/template/images/icon4.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Linkedin"><img src="assets/template/images/icon5.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Reddit"><img src="assets/template/images/icon6.jpg" alt=""></a></li>
					</ul>
					<div class="links">
						<a rel="nofollow" href="assets/template/http://www.templatemonster.com/" target="_blank">Website template</a> designed by TemplateMon/ster.com<br>
						<a href="assets/template/http://www.templates.com/product/3d-models/" target="_blank">3D Models</a> assets/template/provided by Templates.com</div>
				</div>
			</footer>
			<!--footer end-->
		</div>
